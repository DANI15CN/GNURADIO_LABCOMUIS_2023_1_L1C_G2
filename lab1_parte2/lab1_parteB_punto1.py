...
class lab1_parteB_punto1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab1_parteB_punto1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab1_parteB_punto1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_parteB_punto1")
...
def main(top_block_cls=lab1_parteB_punto1, options=None):
