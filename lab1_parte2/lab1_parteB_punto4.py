...
class lab1_parteB_punto4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab1_parteB_punto4")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab1_parteB_punto4")
...
def main(top_block_cls=lab1_parteB_punto4, options=None):
